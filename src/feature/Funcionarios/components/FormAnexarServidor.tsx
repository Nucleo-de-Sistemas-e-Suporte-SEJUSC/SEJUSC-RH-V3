...
export default function FormAnexarServidor({
  isModalOpen,
  setIsModalOpen,
}: FormAnexarServidorProps) {
      ...
      <form>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-6">
            ...
            <label className="flex grow justify-between rounded p-1.5 font-medium text-slate-800 duration-100 ease-in hover:cursor-pointer hover:bg-slate-300">
              ...
              <input
                ...
                onChange={(event) =>
                  handleFileChange("CERTIDAO_RESERVISTA", event)
                }
              />
            </label>
            <label className="flex grow justify-between rounded p-1.5 font-medium text-slate-800 duration-100 ease-in hover:cursor-pointer hover:bg-slate-300">
              ...
              <input
                ...
                onChange={(event) =>
                  handleFileChange("COMPROVANTE_ESCOLARIDADE", event)
                }
              />
            </label>
            <label className="flex grow justify-between rounded p-1.5 font-medium text-slate-800 duration-100 ease-in hover:cursor-pointer hover:bg-slate-300">
            ...
            <label className="flex grow justify-between rounded p-1.5 font-medium text-slate-800 duration-100 ease-in hover:cursor-pointer hover:bg-slate-300">
              ...
              <input
                ...
                onChange={(event) =>
                  handleFileChange("CERTIDAO_NASCIMENTO", event)
                }
              />
            </label>
            <label className="flex grow justify-between rounded p-1.5 font-medium text-slate-800 duration-100 ease-in hover:cursor-pointer hover:bg-slate-300">
          ...
          <div className="flex gap-4">
            <Button onClick={handleSubmit}>Anexar Documentos</Button>
            <Button
              type="button"
              onClick={() =>
                setIsModalOpen({
